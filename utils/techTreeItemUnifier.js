...
function findLearnableItems(schematicType, allItems) {
	...
	const specialCaseMap = {
		...
		Constructions_T3Schematic_C: ["Giant Wall Gate", "Giant Wall Packer"],
		Stations_T3Schematic_C: ["Advanced Windmill"],
		Vitamins_T3Schematic_C: ["Bonebreaker"],
		Tools_T3Schematic_C: ["Chitin PickAxe"],

...
class TechParser extends BaseParser {
  ...
  parseTechData(filePath) {
    ...
    tech.name = this.dataParser.parseName(this.translator, techData.Properties.TechTreeName);
    ...
    if (techData.Properties.TechTreeUnlocks && techData.Properties.TechTreeUnlocks.length > 0) {

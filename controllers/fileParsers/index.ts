...
import * as poiParsers from "./poiParsers";
...
export const addPoiMapping = utilityFunctions.addPoiMapping;
export const getPoiMapping = utilityFunctions.getPoiMapping;
export const parsePoiData = poiParsers.parsePoiData;

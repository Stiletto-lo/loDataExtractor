 ...
 */
const loadDirData = (dir: string, type: FileType): void => {
 ...
 * @param contentFolderPath - Base path of the content
 */
const loadAllFiles = (contentFolderPath: string): void => {
...
export { loadDirData, loadAllFiles };